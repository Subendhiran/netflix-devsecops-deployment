...
pipeline {
    ...
    stages {
        ...
        stage('Checkout from Git') {
            steps {
                git branch: 'main', url: 'https://github.com/Subendhiran/nextflix.git'
            }
        }
        ...
        stage("Docker Push"){
            steps{
                script {
                    ...
                    sh "docker tag netflix subendhiran/netflix:latest "
                    sh "docker push subendhiran/netflix:latest"
                    }
                }
            }
        }
